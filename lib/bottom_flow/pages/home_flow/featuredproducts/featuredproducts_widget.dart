...
import 'featuredproducts_model.dart';
export 'featuredproducts_model.dart';

class FeaturedproductsWidget extends StatefulWidget {
  const FeaturedproductsWidget({super.key});

  static String routeName = 'Featuredproducts';
  static String routePath = '/featuredproducts';
                                ...
                                child: InkWell(
                                  ...
                                  child: wrapWithModel(
                                    ...
                                    child: ItemsComponentWidget(
                                      key: Key(
                                        'Key0k7_${popularListIndex.toString()}',
                                      ),
