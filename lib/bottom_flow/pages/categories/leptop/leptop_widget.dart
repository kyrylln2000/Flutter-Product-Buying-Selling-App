...
import 'leptop_model.dart';
export 'leptop_model.dart';

class LeptopWidget extends StatefulWidget {
  const LeptopWidget({super.key});

  static String routeName = 'leptop';
  static String routePath = '/leptop';

  @override
  State<LeptopWidget> createState() => _LeptopWidgetState();
}

class _LeptopWidgetState extends State<LeptopWidget> {
  late LeptopModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeptopModel());
            ...
            children: [
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final categories = FFAppState().leptop.toList();
                          ...
                          return InkWell(
                            ...
                            child: wrapWithModel(
                              ...
                              child: CategorioesComponentWidget(
                                key: Key(
                                  'Key831_${categoriesIndex.toString()}',
                                ),
