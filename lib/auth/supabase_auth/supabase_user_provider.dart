...
class SougkSupabaseUser extends BaseAuthUser {
  SougkSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> sougkSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = SougkSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
