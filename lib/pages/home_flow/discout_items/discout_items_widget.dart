...
import 'discout_items_model.dart';
export 'discout_items_model.dart';

class DiscoutItemsWidget extends StatefulWidget {
  const DiscoutItemsWidget({super.key});

  static String routeName = 'DiscoutItems';
  static String routePath = '/discoutItems';

  @override
  State<DiscoutItemsWidget> createState() => _DiscoutItemsWidgetState();
}

class _DiscoutItemsWidgetState extends State<DiscoutItemsWidget> {
  late DiscoutItemsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DiscoutItemsModel());
  }
                                ...
                                child: InkWell(
                                  ...
                                  child: wrapWithModel(
                                    ...
                                    child: ItemsComponentWidget(
                                      key: Key(
                                        'Keysai_${popularListIndex.toString()}',
                                      ),
